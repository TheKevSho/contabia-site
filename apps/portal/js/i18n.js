...
const I18N = {
  es: {
    ...
    /* ---- bilingual data labels + config page chrome (2026-09-12) ---- */
    'role.co_owner': 'Co-dueño',
    /* exception detail: these three prefix the live description string */
    'exc.live_desc_monto': 'Monto: COP {amount}',
    'exc.live_desc_responsable': 'Responsable: {owner}',
    'exc.live_desc_je': 'JE propuesto: {je}',
    /* config → reglas (live) */
    'conf.reglas_count': '{n} activa{plural}',
    'conf.no_reglas_live': 'Aún no hay reglas registradas. Cada decisión repetible (categorización de un proveedor, tratamiento de comisiones, centro de costos por defecto) se guarda aquí una sola vez.',
    'conf.regla_global_motor': 'regla global (motor)',
    'conf.regla_cliente': 'regla del cliente',
    'conf.autor': 'autor: {who}',
    'conf.excepcion_prefix': 'excepción: {id}',
    'conf.nueva_regla_placeholder': 'Ej.: Las facturas de Inversiones Marina Turística llevan centro de costos según el muelle/embarcación indicado en la descripción.',
    'conf.cat.categorization': 'Categorización',
    'conf.cat.retention': 'Retenciones',
    'conf.cat.cost_center': 'Centro de costos',
    'conf.cat.banking': 'Bancos / pagos',
    'conf.cat.payroll': 'Nómina',
    'conf.cat.account_map': 'Mapeo de cuentas (posting)',
    'conf.cat.other': 'Otra',
    'conf.excepcion_opcional': 'Excepción (opcional): EX-J07-08',
    'conf.escribe_regla': 'Escribe la regla primero.',
    'conf.guardando': 'Guardando…',
    'conf.error_prefix': 'Error: ',
    'conf.regla_no_actualizada': 'No se pudo actualizar la regla: ',
    'conf.ultimo_acceso': 'Último acceso: {when}',
    'conf.notif_evento': 'Evento',
    'conf.notif_destinatarios': 'Destinatarios',
    'conf.otas_canal': 'Canal',
    'conf.otas_modelo': 'Modelo',
    'conf.otas_reservas': 'Reservas mes',
    'conf.otas_comision': 'Comisión mes',
    'conf.edicion_bloqueada': 'Edición bloqueada en mockup. Cambios pasan por Angel.',
    'conf.sync_forzada': 'Sincronización forzada (mockup).',
    'conf.reauth': 'Reautenticación abierta (mockup).',
    'conf.invitar': 'Invitar nuevo miembro (mockup).',
    'conf.editor_reglas_pronto': 'Editor de reglas (próximamente).',
    'conf.regimen_value': 'Responsable de IVA · Régimen ordinario',
    'conf.municipio_value': 'Santa Marta · 5,5 × 1.000',
    'period_month_july': 'Julio 2026',
    /* exception Phase — a register field, shown in the row subtitle next to
       the title, so it has to follow the language too. */
    'phase.3 Revenue': '3 Ingresos',
    'phase.4 AR': '4 CxC',
    'phase.5 Expenses': '5 Gastos',
    'phase.6 Bank': '6 Bancos',
    'phase.8 FX': '8 Diferencia en cambio',
    'phase.9 Payroll': '9 Nómina',
    'phase.10 Tax': '10 Impuestos',
    'phase.11 Provisions': '11 Provisiones',
    'phase.12 Assets': '12 Activos',
    'phase.13 Inventory': '13 Inventario',
    'phase.14 Recurring': '14 Recurrentes',
    'phase.Bank': 'Bancos',
    'phase.Tax': 'Impuestos',
    'phase.Cost Centers': 'Centros de costos',
    'phase.Recurring JEs': 'JEs recurrentes',
  },
  ...
  en: {
    ...
    /* exception detail: these three prefix the live description string */
    'exc.live_desc_monto': 'Amount: COP {amount}',
    'exc.live_desc_responsable': 'Owner: {owner}',
    'exc.live_desc_je': 'Proposed JE: {je}',
    /* config → rules (live) */
    'conf.reglas_count': '{n} active',
    'conf.no_reglas_live': 'No rules recorded yet. Each repeatable decision (a vendor\u2019s categorization, commission treatment, default cost center) is stored here once.',
    'conf.regla_global_motor': 'global rule (engine)',
    'conf.regla_cliente': 'client rule',
    'conf.autor': 'author: {who}',
    'conf.excepcion_prefix': 'exception: {id}',
    'conf.nueva_regla_placeholder': 'E.g.: Inversiones Marina Tur\u00edstica invoices carry a cost center based on the dock/vessel named in the description.',
    'conf.cat.categorization': 'Categorization',
    'conf.cat.retention': 'Withholdings',
    'conf.cat.cost_center': 'Cost center',
    'conf.cat.banking': 'Banking / payments',
    'conf.cat.payroll': 'Payroll',
    'conf.cat.account_map': 'Account mapping (posting)',
    'conf.cat.other': 'Other',
    'conf.excepcion_opcional': 'Exception (optional): EX-J07-08',
    'conf.escribe_regla': 'Write the rule first.',
    'conf.guardando': 'Saving\u2026',
    'conf.error_prefix': 'Error: ',
    'conf.regla_no_actualizada': 'Could not update the rule: ',
    'conf.ultimo_acceso': 'Last login: {when}',
    'conf.notif_evento': 'Event',
    'conf.notif_destinatarios': 'Recipients',
    'conf.otas_canal': 'Channel',
    'conf.otas_modelo': 'Model',
    'conf.otas_reservas': 'Reservations (month)',
    'conf.otas_comision': 'Commission (month)',
    'conf.edicion_bloqueada': 'Editing locked in the mockup. Changes go through Angel.',
    'conf.sync_forzada': 'Forced sync (mockup).',
    'conf.reauth': 'Re-authentication opened (mockup).',
    'conf.invitar': 'Invite new member (mockup).',
    'conf.editor_reglas_pronto': 'Rule editor (coming soon).',
    'conf.regimen_value': 'IVA responsible · Ordinary regime',
    'conf.municipio_value': 'Santa Marta · 5.5 × 1,000',
    'period_month_july': 'July 2026',
    /* exception Phase — mirrors the register's Phase field */
    'phase.3 Revenue': '3 Revenue',
    'phase.4 AR': '4 AR',
    'phase.5 Expenses': '5 Expenses',
    'phase.6 Bank': '6 Bank',
    'phase.8 FX': '8 FX',
    'phase.9 Payroll': '9 Payroll',
    'phase.10 Tax': '10 Tax',
    'phase.11 Provisions': '11 Provisions',
    'phase.12 Assets': '12 Assets',
    'phase.13 Inventory': '13 Inventory',
    'phase.14 Recurring': '14 Recurring',
    'phase.Bank': 'Bank',
    'phase.Tax': 'Tax',
    'phase.Cost Centers': 'Cost Centers',
    'phase.Recurring JEs': 'Recurring JEs',
  },
};
