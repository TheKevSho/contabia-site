...
const I18N = {
  es: {
    ...
    open: 'Abiertas',
    closed: 'Cerradas',
    pending_edwin: 'Pendiente (Contador)',
    ready: 'A · Listos (julio)',
    estimated: 'B · Estimados',
    disclose: 'C · Solo revelar',
    baseline_jes: 'Línea base ene–jun',
    wa_fwd: 'Reenvíe documentos a su chat personal con ContabIA (el mismo número).',
    'common.all': 'Todas',
    ...
    'je.filter.pendientes_edwin': 'Pendientes (Contador)',
    ...
    'je.status.pending_edwin': 'Pendiente (Contador)',
    'je.status.approved_edwin': 'Aprobado por Contador',
    ...
    'je.approved_edwin_tag': '✓ Aprobado por Contador · listo para postear',
    ...
    'je.panel_judgment_calls': 'D · Decisiones pendientes del Contador (sin asiento todavía)',
    ...
    'je.group_b_estimated': 'B · Estimado — Contador confirma cifra',
    ...
    'je.alert_pending_edwin': '{n} comprobante{plural} esperan aprobación del Contador. Nada se postea a Alegra hasta que el Contador apruebe cada uno.',
    ...
    'tracker.pendientes_edwin': '{n} pendientes Contador',
    ...
    'login.hermes_chat': 'Chat personal de ContabIA',
    'login.hermes_alert': 'Reenvíe documentos a su chat personal de ContabIA en WhatsApp.',
    'login.soy': 'Soy',
    'login.owner': 'Dueño',
    ...
    'conf.notif_live': 'Notificaciones: reenvíe documentos a su chat personal de ContabIA en WhatsApp.',
    ...
    'del.meta.live': 'Tayrona Sailing · julio 2026 EN CURSO · nada causado',
    'del.error_load': 'No se pudo cargar entregables',
    'del.files': 'archivos',
    'del.empty': 'vacío',
    'del.download': 'Descargar',
    'del.not_ready': 'En preparación',
    'del.tab.presente': 'Presente',
    'del.tab.modelado': 'Modelado',
    'del.stamp.modelo': 'MODELO — no es cierre oficial',
    'del.banner.presente': '<b>Presente</b> — 15 columnas (Ene–Jul REAL + quincenas + Nov–Dic). Ago–Dic vacíos: el xlsx no tiene valores de proyección. Julio no cerrado. Sombra incluida, colapsada.',
    'del.banner.modelado': '<b>Modelado</b> — 27 columnas (incluye 2027). Palancas primero; clic en celda de proyección para override. Relleno = Jul × factor, itálica / PROY — no es cierre oficial.',
    'del.palanca.ventas': 'Ventas vs Jul',
    'del.palanca.nomina': 'Nómina vs Jul',
    'del.palanca.loan': 'Aplazar préstamo (demo: sin salida de caja en proyección)',
    'del.palanca.demo': 'Palancas rellenan Ago–Dic 2026 como Jul × factor, en itálica / PROY. No se envían a Alegra. 2027 queda vacío.',
    'del.concepto': 'Concepto',
    'del.estado': 'Estado',
    'del.col.real': 'REAL',
    'del.col.quincena': 'QUINCENA',
    'del.col.proy': 'PROY.',
    'del.sec.caja': '1. Posición de caja',
    'del.sec.pl': '2. Estado de resultados (causación)',
    'del.sec.bs': '3. Balance general (libros)',
    'del.sec.shadow': '4. Vista sombra — no se postea a libros',
    'del.row.cash_begin': 'Caja al inicio',
    'del.row.cash_end': 'Caja al final — REAL Alegra (Ene–Jul)',
    'del.row.caja_kids': 'Actividades (operación / inversión / financiación)',
    'del.row.x1': 'Efectivo neto de operación — fórmulas vacías en xlsx',
    'del.row.x2': 'Efectivo neto de inversión — fórmulas vacías en xlsx',
    'del.row.x3': 'Efectivo neto de financiación — fórmulas vacías en xlsx',
    'del.row.x4': 'Brecha no explicada (Edwin reclass — se muestra, no se tapona)',
    'del.row.netrev': 'Total ingresos operacionales',
    'del.row.ventas': 'Ventas totales (Daytrips + Charters + Bar + Buceo)',
    'del.row.ret': 'Devoluciones en ventas',
    'del.row.direct': 'Total costos directos',
    'del.row.cogs': 'Costo de la mercancía vendida',
    'del.row.cos': 'Costo de los servicios vendidos',
    'del.row.gross': 'Utilidad bruta (departmental profit)',
    'del.row.undist': 'Total gastos no distribuidos',
    'del.row.temp': 'Personal temporal · nómina → 2ª quincena',
    'del.row.nom': 'Nómina administrativa fija · → 2ª quincena',
    'del.row.gen': 'Gastos generales',
    'del.row.svc': 'Servicios operacionales en venta',
    'del.row.gop': 'GOP — utilidad operativa bruta = EBITDA',
    'del.row.neta': 'Utilidad neta (causación)',
    'del.row.depr': 'Depreciación PPE',
    'del.row.fin': 'Gastos financieros (intereses)',
    'del.row.tax': 'Gastos por impuestos no acreditables',
    'del.row.assets': 'Total activos',
    'del.row.liab': 'Total pasivos',
    'del.row.equity': 'Total patrimonio',
    'del.row.sA': '4A. Deuda real del velero — LIQUIDADA Feb-2026 (informativa)',
    'del.row.sA1': 'Diferencia vs capital original USD ≈ −1.9% — stay in xlsx notes',
    'del.row.kcomp': '4B. Compensación Kevin — acumulado adeudado (Jul REAL 8.976.900)',
    'del.row.sC': '4C. Distribución socios Kevin 46.081.000 / Nick 41.081.000 (estático)',
    'del.row.sD': '4D. Posición entre socios (Libro 1 empresa ≠ Libro 2 Nick)',
    'del.row.sE': '4E. Contingencias (OTA IVA, exposición IVA, laboral) — vigentes, no se proyectan',
  },
  ...
  en: {
    ...
    open: 'Open',
    closed: 'Closed',
    pending_edwin: 'Pending (Accountant)',
    ready: 'A · Ready (July)',
    estimated: 'B · Estimated',
    disclose: 'C · Disclose only',
    baseline_jes: 'Jan–Jun baseline',
    wa_fwd: 'Forward documents to your personal ContabIA self-chat (same number).',
    'common.all': 'All',
    ...
    'je.filter.pendientes_edwin': 'Pending (Accountant)',
    ...
    'je.status.pending_edwin': 'Pending (Accountant)',
    'je.status.approved_edwin': 'Approved by Accountant',
    ...
    'je.approved_edwin_tag': '✓ Approved by Accountant · ready to post',
    ...
    'je.panel_judgment_calls': 'D · Pending accountant decisions (no entry yet)',
    ...
    'je.group_b_estimated': 'B · Estimated — Accountant confirms figure',
    ...
    'je.alert_pending_edwin': '{n} journal entr{plural} waiting for accountant approval. Nothing posts to Alegra until the accountant approves each.',
    ...
    'tracker.pendientes_edwin': '{n} pending accountant',
    ...
    'login.hermes_chat': 'ContabIA personal chat',
    'login.hermes_alert': 'Forward documents to your personal ContabIA chat on WhatsApp.',
    'login.soy': 'I am',
    'login.owner': 'Owner',
    ...
    'conf.notif_live': 'Notifications: forward documents to your personal ContabIA chat on WhatsApp.',
    ...
    'del.meta.live': 'Tayrona Sailing · July 2026 IN PROGRESS · nothing posted',
    'del.error_load': 'Could not load deliverables',
    'del.files': 'files',
    'del.empty': 'empty',
    'del.download': 'Download',
    'del.not_ready': 'Not ready',
    'del.tab.presente': 'Present',
    'del.tab.modelado': 'Modeled',
    'del.stamp.modelo': 'MODEL — not an official close',
    'del.banner.presente': '<b>Present</b> — 15 columns (Jan–Jul REAL + fortnights + Nov–Dec). Aug–Dec empty: the xlsx has no stored forecast values. July not closed. Shadow in, collapsed.',
    'del.banner.modelado': '<b>Modeled</b> — 27 columns (adds 2027). Levers first; click a forecast cell to override. Fill = Jul × factor, italic / PROY — not an official close.',
    'del.palanca.ventas': 'Sales vs Jul',
    'del.palanca.nomina': 'Payroll vs Jul',
    'del.palanca.loan': 'Defer loan (demo: no cash drain in forecast)',
    'del.palanca.demo': 'Levers fill Aug–Dec 2026 as Jul × factor, italic / PROY. Not posted to Alegra. 2027 stays empty.',
    'del.concepto': 'Line',
    'del.estado': 'Status',
    'del.col.real': 'REAL',
    'del.col.quincena': 'FORTNIGHT',
    'del.col.proy': 'PROJ.',
    'del.sec.caja': '1. Cash position',
    'del.sec.pl': '2. Income statement (accrual)',
    'del.sec.bs': '3. Balance sheet (books)',
    'del.sec.shadow': '4. Shadow view — not posted to books',
    'del.row.cash_begin': 'Cash at start',
    'del.row.cash_end': 'Cash at end — REAL Alegra (Jan–Jul)',
    'del.row.caja_kids': 'Activities (operating / investing / financing)',
    'del.row.x1': 'Net cash from operations — empty formulas in xlsx',
    'del.row.x2': 'Net cash from investing — empty formulas in xlsx',
    'del.row.x3': 'Net cash from financing — empty formulas in xlsx',
    'del.row.x4': 'Unexplained gap (Edwin reclass — shown, not plugged)',
    'del.row.netrev': 'Total operating revenue',
    'del.row.ventas': 'Total sales (Daytrips + Charters + Bar + Diving)',
    'del.row.ret': 'Sales returns',
    'del.row.direct': 'Total direct costs',
    'del.row.cogs': 'Cost of goods sold',
    'del.row.cos': 'Cost of services sold',
    'del.row.gross': 'Gross profit (departmental)',
    'del.row.undist': 'Total undistributed expenses',
    'del.row.temp': 'Temporary staff · payroll → 2nd fortnight',
    'del.row.nom': 'Fixed admin payroll · → 2nd fortnight',
    'del.row.gen': 'General expenses',
    'del.row.svc': 'Selling operational services',
    'del.row.gop': 'GOP — gross operating profit = EBITDA',
    'del.row.neta': 'Net income (accrual)',
    'del.row.depr': 'PPE depreciation',
    'del.row.fin': 'Finance expense (interest)',
    'del.row.tax': 'Non-creditable tax expense',
    'del.row.assets': 'Total assets',
    'del.row.liab': 'Total liabilities',
    'del.row.equity': 'Total equity',
    'del.row.sA': '4A. Actual boat debt — SETTLED Feb-2026 (informational)',
    'del.row.sA1': 'Vs original USD principal ≈ −1.9% — stay in xlsx notes',
    'del.row.kcomp': '4B. Kevin compensation — accrued owed (Jul REAL 8,976,900)',
    'del.row.sC': '4C. Partner split Kevin 46,081,000 / Nick 41,081,000 (static)',
    'del.row.sD': '4D. Inter-partner position (Book 1 company ≠ Book 2 Nick)',
    'del.row.sE': '4E. Contingencies (OTA VAT, VAT exposure, labor) — live, not forecast',
  },
};
...
function statusLabelI18n(s) {
  ...
  const es = {
    ...
    pending: 'Pendiente', pending_edwin_approval: 'Pendiente (Contador)',
    approved_by_edwin: 'Aprobado por Contador', disclosure_only: 'Solo revelar',
    in_review: 'En revisión',
  };
  const en = {
    open: 'Open', closed: 'Closed', approved: 'Approved', rejected: 'Rejected',
    pending: 'Pending', pending_edwin_approval: 'Pending (Accountant)',
    approved_by_edwin: 'Approved by Accountant', disclosure_only: 'Disclose only',
    in_review: 'In review',
  };
