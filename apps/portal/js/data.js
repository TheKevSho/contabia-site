...
const DATA = {
  ...
  'cantamar-001': {
    ...
    connectors: [
      ...
      { id: 'gmail',    name: 'Gmail',     status: 'ok',   last_sync: '6:08 a.m.' },
    ...
    exceptions: [
      ...
      { id: 'exc-002', subtype: 'revenue.pms_alegra_gap',          status: 'in_review', priority: 'critical',
        ...
        description: 'Reserva en LobbyPMS (checkout 29/06/2026) de COP 620.000 sin factura correspondiente en Alegra.',
        ai_recommendation: 'Generar factura de venta en Alegra por COP 620.000 (canal: Booking.com, Modelo Factura Mensual).',
        ai_confidence: 0.91, created_at: '2026-07-02' },
      { id: 'exc-003', subtype: 'receipt.recoverable_candidate',   status: 'pending',   priority: 'high',
        ...
        ai_confidence: 0.88, created_at: '2026-07-03' },
      { id: 'exc-004', subtype: 'bank_rec.unmatched_credit',       status: 'pending',   priority: 'critical',
        ...
        description: 'Crédito en cuenta Bancolombia el 16/06/2026 de COP 1.450.000. Descripción: "TRANSF MÓVIL". Sin contrapartida en Alegra.',
        ai_recommendation: 'No se pudo identificar automáticamente. Requiere revisión manual.',
        ai_confidence: 0.38, created_at: '2026-07-02' },
      { id: 'exc-005', subtype: 'revenue.phantom_commission_delta', status: 'pending',  priority: 'high',
        ...
        ai_confidence: 0.94, created_at: '2026-07-02' },
      { id: 'exc-006', subtype: 'bank_rec.unmatched_debit',         status: 'in_review', priority: 'high',
        ...
        description: 'Pago ACH el 19/06/2026 de COP 87.500. Descripción: "PAGO SERV PUBLICOS ACH". Sin entrada contable.',
        ai_recommendation: 'Cuenta sugerida: 5215 (Servicios Públicos). Confianza: 71%.',
        ai_confidence: 0.71, created_at: '2026-07-03' },
      { id: 'exc-007', subtype: 'payroll.provision_drift',          status: 'pending',   priority: 'high',
        ...
        ai_recommendation: 'Revisar empleado Yaritza González — posible error de divisor en cálculo de junio (30 vs. 31 días).',
        ai_confidence: 0.82, created_at: '2026-07-04' },
    ],
    ...
    journalEntries: [
      ...
      { id: 'je-005', subtype: 'je.ota_grossup.phantom_commission', status: 'blocked', priority: 'high',
        ...
        ai_confidence: 0.94, created_at: '2026-07-02', blocked_by: 'exc-005',
        lines: [
    ...
    deliverables: [
      ...
      { name: 'Escaneo gratuito — abril 2026',         type: 'pdf',  size: '120 KB', period: 'Abril 2026',   ready: true,  source: 'free_scan',
        ...
        path: '../../contabia public site/free-scan/escaneo_vamos_navegando_sas_20260405.pdf' },
    ],

    /* ---- BÓVEDA — input/upload store. Inverse of Entregables. ---- */
    boveda: [
      { id:'b-1',  filename:'Bancolombia_extracto_junio_2026.pdf',     folder:'Banco',                type:'pdf',  size:'380 KB', uploaded_by:'agent',   uploaded_at:'2026-07-05 06:12', tags:['banco','cierre'],     processed:true,  linked_to:'JE-05 (concil. bancaria)' },
      { id:'b-2',  filename:'Bancolombia_extracto_mayo_2026.pdf',   folder:'Banco',                type:'pdf',  size:'372 KB', uploaded_by:'agent',   uploaded_at:'2026-06-05 06:00', tags:['banco','cierre'],     processed:true,  linked_to:'Cierre febrero' },
      { id:'b-3',  filename:'ferreteria_el_tornillo_29062026.jpg',     folder:'Recibos',              type:'img',  size:'212 KB', uploaded_by:'whatsapp',uploaded_at:'2026-06-29 14:22', tags:['compras'],            processed:true,  linked_to:'EXC-003' },
      { id:'b-4',  filename:'aws_invoice_junio_2026.pdf',              folder:'Recibos',              type:'pdf',  size:'48 KB',  uploaded_by:'email',   uploaded_at:'2026-07-02 09:05', tags:['compras','exterior'],processed:false, linked_to:null },
      { id:'b-5',  filename:'taxi_marina_16062026.jpg',                folder:'Recibos',              type:'img',  size:'180 KB', uploaded_by:'whatsapp',uploaded_at:'2026-06-16 18:40', tags:['compras'],            processed:true,  linked_to:null },
      { id:'b-6',  filename:'transportes_sp_factura_23jun2026.pdf',    folder:'Facturas Proveedores', type:'pdf',  size:'92 KB',  uploaded_by:'agent',   uploaded_at:'2026-06-23 11:15', tags:['compras','retefuente'], processed:true, linked_to:'EXC-001' },
      { id:'b-7',  filename:'booking_statement_junio_2026.xlsx',       folder:'OTAs',                 type:'xls',  size:'140 KB', uploaded_by:'agent',   uploaded_at:'2026-07-03 08:30', tags:['ingresos'],           processed:true,  linked_to:'JE-02' },
      { id:'b-8',  filename:'airbnb_payouts_junio.pdf',                folder:'OTAs',                 type:'pdf',  size:'88 KB',  uploaded_by:'agent',   uploaded_at:'2026-07-03 08:32', tags:['ingresos'],           processed:true,  linked_to:null },
      { id:'b-9',  filename:'F300_2024_2025.pdf',                      folder:'Onboarding',           type:'pdf',  size:'420 KB', uploaded_by:'kevin',   uploaded_at:'2026-04-16 16:00', tags:['onboarding'],         processed:true,  linked_to:'Posición fiscal base' },
      { id:'b-10', filename:'retefuente_2025.pdf',                     folder:'Onboarding',           type:'pdf',  size:'310 KB', uploaded_by:'kevin',   uploaded_at:'2026-04-16 16:02', tags:['onboarding'],         processed:true,  linked_to:'Posición fiscal base' },
      { id:'b-11', filename:'contrato_arriendo_local.pdf',             folder:'Otros',                type:'pdf',  size:'520 KB', uploaded_by:'kevin',   uploaded_at:'2026-05-02 10:00', tags:[],                     processed:false, linked_to:null },
    ],
    ...
    nomina: {
      ...
      ot_pending: [
        { id:'ot-1', employee:'Carlos Pérez',   date:'2026-06-23', hours:3, recargo:'Nocturno', reason:'Cobertura noche sábado',          status:'pending' },
        { id:'ot-2', employee:'Camilo Vargas',  date:'2026-06-24', hours:2, recargo:'Dominical', reason:'Brunch domingo grupo grande',     status:'pending' },
        { id:'ot-3', employee:'Ana Torres',     date:'2026-06-30', hours:4, recargo:'Festivo',   reason:'Servicio especial Semana Santa', status:'pending' },
      ],
      ops_kpis: {
        ocupacion_avg:    71,
        productividad:    82,
      ...
      recent_marcaciones: [
        { employee:'Yaritza González', date:'2026-07-01', in:'07:50', out:'17:05', hours:9.25 },
        { employee:'Carlos Pérez',     date:'2026-07-01', in:'14:00', out:'23:10', hours:9.17 },
        { employee:'Diana Ramírez',    date:'2026-07-01', in:'06:55', out:'15:00', hours:8.08 },
        { employee:'Camilo Vargas',    date:'2026-07-01', in:'17:00', out:'02:15', hours:9.25, dispute:'Marcación de salida revisada por Yari' },
        { employee:'Ana Torres',       date:'2026-07-01', in:'11:00', out:'21:00', hours:10.00 },
      ],
    },
    ...
    /* ---- AUDIT LOG ---- */
    audit_log: [
      { ts:'2026-07-05 06:12', source:'Bancolombia', type:'bank_pull',  desc:'147 transacciones de junio extraídas', hash:'a3f7c92d', user:'agent' },
      { ts:'2026-07-05 06:10', source:'Alegra',      type:'fe_check',   desc:'87 facturas verificadas vs DIAN',      hash:'b1e2f08a', user:'agent' },
      { ts:'2026-07-05 06:08', source:'LobbyPMS',    type:'pms_pull',   desc:'89 reservas junio · 5 canales OTA',    hash:'c9d4a17b', user:'agent' },
      { ts:'2026-07-05 06:05', source:'motor',       type:'rule_apply', desc:'OTA accrual rule R3 · 12 transacciones', hash:'d2e83ba1', user:'system' },
      { ts:'2026-07-05 06:00', source:'motor',       type:'reconcile',  desc:'3-way conciliación ejecutada',         hash:'f1a72c50', user:'system' },
      { ts:'2026-07-04 22:50', source:'WhatsApp',    type:'receipt',    desc:'Recibo Ferretería El Tornillo · OCR 88%', hash:'e7f12219', user:'manager' },
      { ts:'2026-07-04 18:20', source:'RADIAN',      type:'fe_inbound', desc:'12 facturas de proveedores recibidas', hash:'a8b32d11', user:'agent' },
      { ts:'2026-07-03 15:00', source:'motor',       type:'rule_change',desc:'Regla "TRANSPORTES SP → 5215" creada por Edwin', hash:'c3d9e4f2', user:'edwin' },
    ],
  ...
  'sonata-001': {
    ...
    connectors: [
      ...
      { id: 'gmail',    name: 'Gmail',     status: 'warn', last_sync: 'ayer 18:00' },
    ...
    exceptions: [
      { id: 'exc-101', subtype: 'connector.ota_portal_locked',     status: 'pending', priority: 'critical',
        ...
        description: 'Sin acceso al portal de GetYourGuide para confirmar comisión de junio (COP 892.400). 2FA bloqueado.',
      ...
      { id: 'exc-102', subtype: 'revenue.pms_alegra_gap',          status: 'pending', priority: 'high',
        ...
        description: 'Charter en LobbyPMS (CHR-2117, salida 23/06/2026) de COP 920.000 sin FE en Alegra.',
        ai_recommendation: 'Generar factura de venta en Alegra por COP 920.000 (canal: Viator).',
        ai_confidence: 0.93, created_at: '2026-07-03' },
      { id: 'exc-103', subtype: 'fixed_asset.capitalization_flag', status: 'in_review', priority: 'high',
        ...
        ai_confidence: 0.78, created_at: '2026-07-03' },
      { id: 'exc-104', subtype: 'tax.retefuente_missed',           status: 'pending', priority: 'high',
        ...
        ai_confidence: 0.94, created_at: '2026-07-03' },
      { id: 'exc-105', subtype: 'bank_rec.unmatched_credit',       status: 'pending', priority: 'high',
        title: 'Crédito BBVA sin identificar — COP 720.000',
        description: 'Crédito en BBVA el 15/06/2026. Descripción: "ABONO CHARTER JUN". Sin contrapartida.',
        ai_recommendation: 'Posible anticipo de charter grupal. Cruzar con bookings de junio sin pago.',
        ai_confidence: 0.52, created_at: '2026-07-02' },
    ],
    ...
    journalEntries: [
      ...
      { id: 'je-105', subtype: 'je.fixed_asset.flag',     status: 'blocked',  priority: 'high',
        ...
        ai_confidence: 0.62, created_at: '2026-07-03', blocked_by: 'exc-103',
        lines: [] },
    ],
    ...
    /* ---- BÓVEDA ---- */
    boveda: [
      { id:'b-1',  filename:'BBVA_extracto_junio_2026.pdf',           folder:'Banco',                type:'pdf', size:'420 KB', uploaded_by:'agent',   uploaded_at:'2026-07-05 05:55', tags:['banco','cierre'],       processed:true,  linked_to:'JE-05 (concil. BBVA)' },
      { id:'b-2',  filename:'Bancolombia_extracto_junio_2026.pdf',    folder:'Banco',                type:'pdf', size:'298 KB', uploaded_by:'agent',   uploaded_at:'2026-07-05 05:56', tags:['banco','cierre'],       processed:true,  linked_to:'JE-05 (concil. Bancol.)' },
      { id:'b-3',  filename:'astilleros_caribe_16jun2026.pdf',        folder:'Facturas Proveedores', type:'pdf', size:'154 KB', uploaded_by:'agent',   uploaded_at:'2026-06-16 11:00', tags:['compras','retefuente'], processed:true,  linked_to:'EXC-104' },
      { id:'b-4',  filename:'combustible_marina_23jun2026.jpg',       folder:'Recibos',              type:'img', size:'240 KB', uploaded_by:'whatsapp',uploaded_at:'2026-06-23 14:30', tags:['compras'],              processed:true,  linked_to:null },
      { id:'b-5',  filename:'repuestos_motor_19jun2026.jpg',          folder:'Recibos',              type:'img', size:'195 KB', uploaded_by:'whatsapp',uploaded_at:'2026-06-19 09:45', tags:['compras'],              processed:false, linked_to:null },
      { id:'b-6',  filename:'civitatis_junio_2026.xlsx',              folder:'OTAs',                 type:'xls', size:'112 KB', uploaded_by:'agent',   uploaded_at:'2026-07-03 09:00', tags:['ingresos'],             processed:true,  linked_to:null },
      { id:'b-7',  filename:'viator_junio_2026.pdf',                  folder:'OTAs',                 type:'pdf', size:'76 KB',  uploaded_by:'agent',   uploaded_at:'2026-07-03 09:05', tags:['ingresos'],             processed:true,  linked_to:null },
      { id:'b-8',  filename:'getyourguide_PENDIENTE_2fa.txt',         folder:'OTAs',                 type:'pdf', size:'2 KB',   uploaded_by:'agent',   uploaded_at:'2026-07-05 05:05', tags:['ingresos','bloqueado'],processed:false, linked_to:'EXC-101' },
      { id:'b-9',  filename:'F300_2024_2025_sonata.pdf',              folder:'Onboarding',           type:'pdf', size:'380 KB', uploaded_by:'kevin',   uploaded_at:'2026-04-21 14:30', tags:['onboarding'],           processed:true,  linked_to:'Posición fiscal base' },
      { id:'b-10', filename:'certificado_navegacion_sonata.pdf',      folder:'Otros',                type:'pdf', size:'180 KB', uploaded_by:'nick',    uploaded_at:'2026-05-13 11:00', tags:['legal'],                processed:true,  linked_to:null },
    ],
    ...
    nomina: {
      ...
      ot_pending: [
        { id:'ot-1', employee:'Juan Camilo R.', date:'2026-06-24', hours:4, recargo:'Dominical', reason:'Charter privado domingo', status:'pending' },
        { id:'ot-2', employee:'Andrés Mora',    date:'2026-06-30', hours:6, recargo:'Festivo',   reason:'Charter Semana Santa',   status:'pending' },
      ],
      ops_kpis: {
      ...
      recent_marcaciones: [
        { employee:'Nicolás Giraldo', date:'2026-07-01', in:'06:30', out:'18:45', hours:12.25 },
        { employee:'Juan Camilo R.',  date:'2026-07-01', in:'06:45', out:'17:30', hours:10.75 },
        { employee:'Andrés Mora',     date:'2026-07-01', in:'06:45', out:'19:00', hours:12.25, dispute:'Marcación de salida después de retorno tardío' },
        { employee:'Esteban Pinto',   date:'2026-06-30', in:'07:00', out:'17:00', hours:10.00 },
      ],
    },
    ...
    /* ---- AUDIT LOG ---- */
    audit_log: [
      { ts:'2026-07-05 05:55', source:'BBVA',        type:'bank_pull',  desc:'94 transacciones de junio extraídas', hash:'b8c4f217', user:'agent' },
      { ts:'2026-07-05 05:50', source:'Alegra',      type:'fe_check',   desc:'49 facturas verificadas vs DIAN',     hash:'a2d8e305', user:'agent' },
      { ts:'2026-07-05 05:42', source:'LobbyPMS',    type:'pms_pull',   desc:'51 charters junio · 4 canales OTA',   hash:'c4f1b203', user:'agent' },
      { ts:'2026-07-05 05:30', source:'motor',       type:'depreciation', desc:'Depreciación 3 embarcaciones calculada (Sonata, Anna Lezah, Dragon Lady)', hash:'e9b2a17c', user:'system' },
      { ts:'2026-07-05 05:20', source:'motor',       type:'reconcile',  desc:'3-way conciliación ejecutada',        hash:'f3a91d5e', user:'system' },
      { ts:'2026-07-05 05:05', source:'GetYourGuide', type:'connector_fail', desc:'Portal GYG bloqueado por 2FA — comisión accrual estimada', hash:'d7b18e22', user:'agent' },
      { ts:'2026-07-04 21:10', source:'WhatsApp',    type:'receipt',    desc:'Recibo Combustibles Marina · OCR 92%', hash:'e0c4f917', user:'manager' },
      { ts:'2026-07-03 14:30', source:'motor',       type:'rule_change',desc:'Regla "ASTILLEROS DEL CARIBE → 5160 + retención 4%" creada por Edwin', hash:'a5d2e801', user:'edwin' },
    ],
...
/* Shared seeded intro thread — used by both chat.html's full thread
   and the floating agent widget, so the agent opens with the same
   concrete, useful example everywhere rather than a bare greeting. */
function buildAgentIntroThread(e, user) {
  const meta = e.meta;
  const first = user.name.split(' ')[0];
  const pct = (e.closeSummary && e.closeSummary.pct != null) ? e.closeSummary.pct : null;
  const crit = (e.exceptions || []).filter(x => x.priority === 'critical' && x.status === 'pending').length;
  const risk = e.cifras && e.cifras.plata_en_riesgo;

  const closeLine = pct != null
    ? `El cierre de ${meta.period.toLowerCase()} va en ${pct}%.` + (crit ? ` Hay ${crit} excepci${crit === 1 ? 'ón crítica' : 'ones críticas'} que necesita${crit === 1 ? '' : 'n'} decisión antes de generar informes.` : '')
    : `Aquí estoy para lo que necesite sobre ${meta.name}.`;

  const thread = [
    { who: 'agent', text: `Hola, ${first}. Soy su agente ContabIA. ${closeLine}` },
  ];

  if (risk && risk.breakdown && risk.breakdown.length) {
    const parts = risk.breakdown.map(b => `${fmtCOP(b.value)} de ${b.label.toLowerCase()}`).join(', ');
    thread.push({ who: 'user', text: '¿Cuánto es lo que está en riesgo este mes?' });
    thread.push({ who: 'agent', text: `${fmtCOP(risk.total)} en total: ${parts}. Cada cifra tiene su documento en la Bóveda — puede verificarlas.` });
  }
